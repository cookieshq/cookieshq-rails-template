...
if create_database
  ...
  say("\nWhat you see above is the first failing test of the project. It's caused because you have no routes defined, so the root_path is not visitable. This means everything is set and you can start working (perhaps in making this test pass).\n\n", "\e[33m")
else
